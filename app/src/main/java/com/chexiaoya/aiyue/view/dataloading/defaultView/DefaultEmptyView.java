 ...
 */
public class DefaultEmptyView extends FrameLayout implements ViewStateInterface {
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_default_empty, this, false);
        this.addView(view);
    }
