...
import static com.chexiaoya.cardoverlay.Align.BOTTOM;
import static com.chexiaoya.cardoverlay.Align.LEFT;
import static android.support.v7.widget.RecyclerView.NO_POSITION;
import static com.chexiaoya.cardoverlay.Align.RIGHT;
import static com.chexiaoya.cardoverlay.Align.TOP;
...
public class CustomLayoutManager extends RecyclerView.LayoutManager {
    ...
    public CustomLayoutManager(Config config) {
        this();
    ...
    private void brewAndStartAnimator(int dur, int finalXorY) {
        animator = ObjectAnimator.ofInt(CustomLayoutManager.this, "animateValue", 0, finalXorY);
